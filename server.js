...
// Sample Employee Code of Conduct document content
const codeOfConduct = `
...
// Add language to the manager
manager.addLanguage("en");

// Add document content to the manager
manager.addDocument("en", codeOfConduct, "codeOfConduct");
...
const textToTokenize = "This is a sample text for tokenization.";

// Tokenization using a simple JavaScript function
const tokens = textToTokenize.split(/\s+/); // Split by spaces

console.log('Tokens:', tokens);


// Named Entity Recognition (NER) example
const entities = manager.extractNamedEntities(
  "en",
  "This policy applies to all our employees regardless of employment agreement or rank."
);
